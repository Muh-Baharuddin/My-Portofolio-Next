        ...
        <div className="container">
          <div className="w-full px-4">
            <div className="mx-auto mb-16 max-w-xl text-center">
              ...
              <p className="text-md font-medium text-secondary md:text-lg">Feel free to contact me, {"let's"} exchange insights and continue learning.</p>
            </div>
          </div>
          ...
          <form>
            <div className="w-full lg:mx-auto lg:w-2/3">
              ...
              <div className="mb-8 w-full px-4">
                ...
                <textarea typeof="email" id="email" className="h-32 w-full rounded-md bg-slate-200 p-3 text-dark focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"></textarea>
              </div>
              <div className="w-full px-4">
                <button className="w-full rounded-full bg-primary py-3 px-8 text-base font-semibold bg-slate-950 text-white transition duration-500 hover:opacity-100 hover:shadow-lg">Send</button>
              </div>
            </div>
          </form>
        </div>
