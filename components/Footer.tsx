      ...
      <div className="container">
        <div className="flex flex-wrap">
          <div className="mb-12 w-full px-4 font-medium text-slate-300 md:w-1/3">
            <h2 className="mb-5 text-4xl font-bold text-white">Muh Baharuddin</h2>
            <h3 className="mb-2 text-2xl font-bold">Contact Me</h3>
            <p>muhbaharuddin67@gmail.com</p>
            <p>Depok, Indonesia</p>
          </div>
        ...
        <div className="w-full border-t border-slate-700 pt-10">
          <div className="mb-5 flex items-center justify-center">
            <a
              href="https://instagram.com/m.6ahar_m"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/in/muh-baharuddin-12b28b1bb/"
              target="_blank"
              className="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
            >
              <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="text-center text-xs font-medium text-slate-500">
            Created with <span className="text-pink-500">❤️</span> By <a href="https://instagram.com/m.6ahar_m" target="_blank" className="font-bold text-primary">Muh. Baharuddin Mansur</a>
          </p>
        </div>
      </div>
    </footer>
