        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full self-center px-4 lg:w-1/2">
              <h1 className="text-base font-semibold text-primary md:text-xl">Hallo 👋, {"I'm"} <span className="mt-1 block text-4xl font-bold text-dark dark:text-white lg:text-5xl">Muhammad Baharuddin</span></h1>
